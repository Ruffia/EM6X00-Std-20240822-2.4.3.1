// SemCtrl_Channel2D.cpp : of the CSemCtrl_Channel2D class.
//
//////////////////////////////////////////////////////////////////////
...
CSemCtrl_Channel2D::CSemCtrl_Channel2D()
{
	m_scfCtrl = DefaultCtrlFigures_Channel2D;
}
...
BOOL CSemCtrl_Channel2D::Flush()
{
	...
	hostMSG.bMessageID		= (BYTE)Z80B_Channel_D;
...
const CString& CSemCtrl_Channel2D::FormatText()
{
	// GetPos
	VARIANT varPos = GetPos();
	long lCtlIndex = varPos.lVal;
...
const CString& CSemCtrl_Channel2D::FormatText( VARIANT varPos )
{
