// SemCtrl_Channel2AB.cpp: implementation of the CSemCtrl_Channel2AB class.
//
//////////////////////////////////////////////////////////////////////
...
CSemCtrl_Channel2AB::CSemCtrl_Channel2AB()
{
	m_scfCtrl = DefaultCtrlFigures_Channel2AB;
}
...
BOOL CSemCtrl_Channel2AB::Flush()
{
	WORD				wCtl;
	...
	hostMSG.bMessageID		= (BYTE)Z80B_Channel_B;
...
const CString& CSemCtrl_Channel2AB::FormatText()
{
	// GetPos
	VARIANT varPos = GetPos();
	long lCtlIndex = varPos.lVal;
...
const CString& CSemCtrl_Channel2AB::FormatText( VARIANT varPos )
{
