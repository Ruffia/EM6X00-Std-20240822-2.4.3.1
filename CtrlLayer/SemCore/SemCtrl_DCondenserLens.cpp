// SemCtrl_DCondenserLens.cpp: implementation of the CSemCtrl_DCondenserLens class.
//
//////////////////////////////////////////////////////////////////////
...
CSemCtrl_DCondenserLens::CSemCtrl_DCondenserLens()
{
	m_scfCtrl = DefaultCtrlFigures_DCondenserLens;
...
BOOL CSemCtrl_DCondenserLens::Flush()
{
	WORD				wCtl;
	...
	hostMSG.bMessageID		= (BYTE)Z80A_DCondenserLens;
	hostMSG.bCtlMSGLength	= (BYTE)2;
	hostMSG.bData[1]		= (BYTE)wCtl;

	usb_hostMSG.bMessageID		= (BYTE)Z80A_DCondenserLens;
...
const CString& CSemCtrl_DCondenserLens::FormatText()
{
	// GetPos
	VARIANT varPos = GetPos();
	long lCtlIndex = varPos.lVal;
...
const CString& CSemCtrl_DCondenserLens::FormatText( VARIANT varPos )
{
