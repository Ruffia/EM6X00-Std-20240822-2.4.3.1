// SemCtrl_Signal2Brightness.cpp: implementation of the CSemCtrl_Signal2Brightness class.
//
//////////////////////////////////////////////////////////////////////
...
CSemCtrl_Signal2Brightness::CSemCtrl_Signal2Brightness()
{
	m_scfCtrl = DefaultCtrlFigures_Signal2Brightness;
...
BOOL CSemCtrl_Signal2Brightness::Flush()
{
...
const CString& CSemCtrl_Signal2Brightness::FormatText()
{
	// GetPos
	VARIANT varPos = GetPos();
	long lCtlIndex = varPos.lVal;
...
const CString& CSemCtrl_Signal2Brightness::FormatText( VARIANT varPos )
{
...
*/
void CSemCtrl_Signal2Brightness::SetParams( int nType, double dParam )// Type:类型；Param:要设置的参数值
{
	switch( nType )
	{
