// SemCtrl_OSE.cpp: implementation of the CSemCtrl_OSE class.
//
//////////////////////////////////////////////////////////////////////
...
BOOL CSemCtrl_OSE::Flush()
{
	...
	hostMSG.bMessageID		= (BYTE)Z80B_OSE_SetupParam;
	...
	usb_hostMSG.bMessageID		= (BYTE)Z80B_OSE_SetupParam;
...
const CString& CSemCtrl_OSE::FormatText()
{
...
const CString& CSemCtrl_OSE::FormatText( VARIANT varPos )
{
...
VARIANT CSemCtrl_OSE::SetUp( const OSEncoderParam& oseParam )
{	
	m_oseParam = oseParam; 
	m_scfCtrl.varPos.lVal  = m_oseParam.bFunction;
