...
{ 
	...
	char szBuf[255];
	// 界面元素
	if(GetPrivateProfileString("PromptDlg", "Cap", "", szBuf, 50, m_cPathLocalize) != 0)
		SetWindowText( szBuf );
	if(GetPrivateProfileString("PromptDlg", "OK", "", szBuf, 50, m_cPathLocalize) != 0)
		GetDlgItem(IDOK)->SetWindowText( szBuf );
	if(GetPrivateProfileString("PromptDlg", "CANCEL", "", szBuf, 50, m_cPathLocalize) != 0)
		GetDlgItem(IDCANCEL)->SetWindowText( szBuf );
	if(GetPrivateProfileString("PromptDlg", "YES", "", szBuf, 50, m_cPathLocalize) != 0)
		GetDlgItem(IDYES)->SetWindowText( szBuf );
	if(GetPrivateProfileString("PromptDlg", "NO", "", szBuf, 50, m_cPathLocalize) != 0)
		GetDlgItem(IDNO)->SetWindowText( szBuf );
} 
