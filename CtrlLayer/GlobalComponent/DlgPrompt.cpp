...
CDlgPrompt::CDlgPrompt(CLanguageManagerCtrl* pLanguageManagerCtrl,CWnd* pParent /*=NULL*/)
	: CDialog(CDlgPrompt::IDD, pParent),m_pLanguageManagerCtrl(pLanguageManagerCtrl)
{
...
void CDlgPrompt::Localize()
{ 
	if( m_hWnd == NULL || m_pLanguageManagerCtrl == NULL)
		return;

	GetDlgItem(IDOK)->SetWindowText(m_pLanguageManagerCtrl->GetResString(IDS_OK));
	GetDlgItem(IDCANCEL)->SetWindowText(m_pLanguageManagerCtrl->GetResString(IDS_CANCEL));
	GetDlgItem(IDYES)->SetWindowText(m_pLanguageManagerCtrl->GetResString(IDS_YES));
	GetDlgItem(IDNO)->SetWindowText(m_pLanguageManagerCtrl->GetResString(IDS_NO));
