========================================================================
		ActiveX Control DLL : SEMCORECTRLPANEL_STANDA
========================================================================

ControlWizard has created this project for your SEMCORECTRLPANEL_STANDA ActiveX Control
...
SemCoreCtrlPanel_StandA.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
SemCoreCtrlPanel_StandA control:

SemCoreCtrlPanel_StandACtl.h
	This file contains the declaration of the CSemCoreCtrlPanel_StandACtrl C++ class.

SemCoreCtrlPanel_StandACtl.cpp
	This file contains the implementation of the CSemCoreCtrlPanel_StandACtrl C++ class.

SemCoreCtrlPanel_StandAPpg.h
	This file contains the declaration of the CSemCoreCtrlPanel_StandAPropPage C++ class.

SemCoreCtrlPanel_StandAPpg.cpp
	This file contains the implementation of the CSemCoreCtrlPanel_StandAPropPage C++ class.

SemCoreCtrlPanel_StandACtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSemCoreCtrlPanel_StandACtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file SemCoreCtrlPanel_StandA.rc.
