...
BEGIN_DISPATCH_MAP(CSemCoreCtrlPanel_Stand6Ctrl, COleControl)
	...
	DISP_FUNCTION_ID(CSemCoreCtrlPanel_Stand6Ctrl, "SyncString", dispidSyncString, SyncString, VT_EMPTY, VTS_VARIANT VTS_VARIANT)
...
void CSemCoreCtrlPanel_Stand6Ctrl::SyncString(VARIANT &ResourceID, VARIANT &ResourceString)
{
	...
	case	IDC_DIALOG_SEMCORECTRLPANEL_STAND6_BUTTON_Auto:
		{
			...
			if( m_dlgGrade.m_hWnd != NULL )
				m_dlgGrade.SyncResString( ResourceID.intVal, str );
		}
		break;
	case	0:
		{
