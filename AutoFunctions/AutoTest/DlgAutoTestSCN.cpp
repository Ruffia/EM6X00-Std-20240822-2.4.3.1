...
void CDlgAutoTestSCN::EnableParams( int nIndex, BOOL bEnable )
{
	...
	if( bEnable )
	{
		...
		case	0:
			...
			Flag.lVal	= 1;
			var.lVal	= theApp.m_AT.nAutoTestSCN_OldPos[0];
			Xpos		= var;
		...
		case	2:
			...
			ClassID.lVal = SemControlPanelClass_Stigmator;
			Flag.lVal	= 2;
			var.lVal	= theApp.m_AT.nAutoTestSCN_OldPos[1];
			Ypos		= var;
		...
		case	4:
			...
			Flag.lVal	= 1;
			var.lVal	= theApp.m_AT.nAutoTestSCN_OldPos[2];
			Xpos		= var;
		...
		case	6:
			...
			ClassID.lVal = SemControlPanelClass_ScanShift;
			Flag.lVal	= 2;
			var.lVal	= theApp.m_AT.nAutoTestSCN_OldPos[3];
			Ypos		= var;
	...
	else
	{
		...
		sprintf( Buf, "Auto test for SCN board --- %s\n", str );
...
void CDlgAutoTestSCN::OnStartStigX() 
{
	...
	if( nCheck )
	{
		...
		theApp.m_AT.nAutoTestSCN_OldPos[0] = var.lVal;
		m_bContinue = TRUE;
		m_bReverse	= FALSE;
...
void CDlgAutoTestSCN::OnStartStigY() 
{
	...
	if( nCheck )
	{
		...
		theApp.m_AT.nAutoTestSCN_OldPos[1] = var.lVal;
		m_bContinue = TRUE;
		m_bReverse	= FALSE;
...
void CDlgAutoTestSCN::OnStartShiftX() 
{
	...
	if( nCheck )
	{
		...
		theApp.m_AT.nAutoTestSCN_OldPos[2] = var.lVal;
		m_bContinue = TRUE;
		m_bReverse	= FALSE;
...
void CDlgAutoTestSCN::OnStartShiftY() 
{
	...
	if( nCheck )
	{
		...
		theApp.m_AT.nAutoTestSCN_OldPos[3] = var.lVal;
		m_bContinue = TRUE;
		m_bReverse	= FALSE;
