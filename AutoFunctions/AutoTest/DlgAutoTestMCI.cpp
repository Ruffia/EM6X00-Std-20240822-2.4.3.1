...
void CDlgAutoTestMCI::EnableParams( int nIndex, BOOL bEnable )
{
	...
	if( bEnable )
	{
		...
		case	0:
			...
			Flag.lVal	= 1;
			var.lVal	= theApp.m_AT.nAutoTestMCI_OldPos[0];
			Xpos		= var;
		...
		case	2:
			...
			ClassID.lVal = SemControlPanelClass_Stigmator;
			Flag.lVal	= 2;
			var.lVal	= theApp.m_AT.nAutoTestMCI_OldPos[1];
			Ypos		= var;
		...
		case	4:
			...
			Flag.lVal	= 1;
			var.lVal	= theApp.m_AT.nAutoTestMCI_OldPos[2];
			Xpos		= var;
		...
		case	6:
			...
			ClassID.lVal = SemControlPanelClass_ScanShift;
			Flag.lVal	= 2;
			var.lVal	= theApp.m_AT.nAutoTestMCI_OldPos[3];
			Ypos		= var;
...
//		theApp.SemCoreCtrlPanelMessageProc( ClassID, SerialNumber, Xpos, Ypos, Flag );
	...
	else
	{
		...
		sprintf( Buf, "Auto test for MCI board --- %s\n", str );
...
void CDlgAutoTestMCI::OnStartFineMagX() 
{
	...
	if( nCheck )
	{
		...
		theApp.m_AT.nAutoTestMCI_OldPos[0] = var.lVal;
		m_bContinue = TRUE;
		m_bReverse	= FALSE;
...
void CDlgAutoTestMCI::OnStartFineMagY() 
{
	...
	if( nCheck )
	{
		...
		theApp.m_AT.nAutoTestMCI_OldPos[1] = var.lVal;
		m_bContinue = TRUE;
		m_bReverse	= FALSE;
...
void CDlgAutoTestMCI::OnStartShiftX() 
{
	...
	if( nCheck )
	{
		...
		theApp.m_AT.nAutoTestMCI_OldPos[2] = var.lVal;
		m_bContinue = TRUE;
		m_bReverse	= FALSE;
...
void CDlgAutoTestMCI::OnStartShiftY() 
{
	...
	if( nCheck )
	{
		...
		theApp.m_AT.nAutoTestMCI_OldPos[3] = var.lVal;
		m_bContinue = TRUE;
		m_bReverse	= FALSE;
