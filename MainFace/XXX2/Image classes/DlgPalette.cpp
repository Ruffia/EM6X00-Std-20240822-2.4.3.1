...
CDlgPalette::CDlgPalette(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgPalette::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgPalette)
	m_editalpha = FALSE;
	//}}AFX_DATA_INIT
}
...
BEGIN_MESSAGE_MAP(CDlgPalette, CDialog)
	//{{AFX_MSG_MAP(CDlgPalette)
	ON_WM_PAINT()
...
/////////////////////////////////////////////////////////////////////////////
long CDlgPalette::GetColumn(long index) const
{
	return index % m_numcolumns; 
}
/////////////////////////////////////////////////////////////////////////////
long CDlgPalette::GetRow(long index) const
{
	return index / m_numcolumns; 
}
/////////////////////////////////////////////////////////////////////////////
long CDlgPalette::GetIndex(long row, long col) const
{
...
/////////////////////////////////////////////////////////////////////////////
void CDlgPalette::DrawCell(CDC *pDC, long index)
{
	CRect rect;
...
/////////////////////////////////////////////////////////////////////////////
bool CDlgPalette::GetCellRect(long index, const LPRECT &rect)
{
...
/////////////////////////////////////////////////////////////////////////////
void CDlgPalette::OnEditAlpha() 
{
	UpdateData(1);
	Invalidate(0);	
}
/////////////////////////////////////////////////////////////////////////////
void CDlgPalette::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
...
/////////////////////////////////////////////////////////////////////////////
void CDlgPalette::OnMouseMove(UINT nFlags, CPoint point) 
{
    long x = point.x - m_xoffset;
    long y = point.y - m_yoffset;
...
BOOL CDlgPalette::PromptForFileName(CString& fileName, UINT /*nIDSTitle*/, 
