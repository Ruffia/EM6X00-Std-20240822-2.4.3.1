...
CDlgColorize::CDlgColorize(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgColorize::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgColorize)
	m_hue = 0;
	m_sat = 0;
	m_r = 0;
	m_g = 0;
...
void CDlgColorize::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgColorize)
...
BEGIN_MESSAGE_MAP(CDlgColorize, CDialog)
	//{{AFX_MSG_MAP(CDlgColorize)
	ON_BN_CLICKED(IDCOLORS, OnColors)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgColorize message handlers

BOOL CDlgColorize::OnInitDialog() 
{
