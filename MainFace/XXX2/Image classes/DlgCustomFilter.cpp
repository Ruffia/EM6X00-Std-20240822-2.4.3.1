...
/////////////////////////////////////////////////////////////////////////////
// CDlgCustomFilter dialog


CDlgCustomFilter::CDlgCustomFilter(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgCustomFilter::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgCustomFilter)
	m_Edit1x1 = 0;
	m_Edit1x2 = 0;
	m_Edit1x3 = 0;
	m_Edit1x4 = 0;
...
void CDlgCustomFilter::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgCustomFilter)
...
BEGIN_MESSAGE_MAP(CDlgCustomFilter, CDialog)
	//{{AFX_MSG_MAP(CDlgCustomFilter)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgCustomFilter message handlers

BOOL CDlgCustomFilter::OnInitDialog() 
{
...
void CDlgCustomFilter::OnRadio3x3() 
{
...
void CDlgCustomFilter::OnRadio5x5() 
{
	// TODO: Add your control notification handler code here
...
BOOL CDlgCustomFilter::PromptForFileName(CString& fileName, UINT /*nIDSTitle*/, 
...
//////////////////////////////////////////////////////////////////////////////
void CDlgCustomFilter::OnSelchangePresets() 
{
