...
CDlgDecBpp::CDlgDecBpp(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgDecBpp::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgDecBpp)
	m_maxcolors = 0;
	//}}AFX_DATA_INIT
}


void CDlgDecBpp::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgDecBpp)
...
BEGIN_MESSAGE_MAP(CDlgDecBpp, CDialog)
	//{{AFX_MSG_MAP(CDlgDecBpp)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgDecBpp message handlers

BOOL CDlgDecBpp::OnInitDialog() 
{
