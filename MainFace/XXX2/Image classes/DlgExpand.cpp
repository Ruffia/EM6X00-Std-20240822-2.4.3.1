...
CDlgExpand::CDlgExpand(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgExpand::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgExpand)
	m_newwidth = 0;
	m_newheight = 0;
	m_left = 0;
	m_right = 0;
...
BEGIN_MESSAGE_MAP(CDlgExpand, CDialog)
	//{{AFX_MSG_MAP(CDlgExpand)
...
/////////////////////////////////////////////////////////////////////////////
void CDlgExpand::OnChangeEditL() 
{
	CheckRadioButton(IDC_RADIO1,IDC_RADIO2,IDC_RADIO2);
}
void CDlgExpand::OnChangeEditR() 
{
	CheckRadioButton(IDC_RADIO1,IDC_RADIO2,IDC_RADIO2);
}
void CDlgExpand::OnChangeEditT() 
{
	CheckRadioButton(IDC_RADIO1,IDC_RADIO2,IDC_RADIO2);
}
void CDlgExpand::OnChangeEditB() 
{
	CheckRadioButton(IDC_RADIO1,IDC_RADIO2,IDC_RADIO2);
}
/////////////////////////////////////////////////////////////////////////////
void CDlgExpand::OnCheck8() 
{
	if (m_ckKeepRatio.GetCheck()){
		UpdateData(1);
		m_newheight = (DWORD)(m_newwidth / m_ratio + 0.5f);
...
/////////////////////////////////////////////////////////////////////////////
void CDlgExpand::OnCheck1() 
{
	CheckRadioButton(IDC_RADIO1,IDC_RADIO2,IDC_RADIO1);
}
void CDlgExpand::OnCheck2() 
{
	CheckRadioButton(IDC_RADIO1,IDC_RADIO2,IDC_RADIO1);
}
/////////////////////////////////////////////////////////////////////////////
