...
{ }
/////////////////////////////////////////////////////////////////////////////
BOOL CDlgHisto::Create(CWnd* pParentWnd, LPCTSTR lpszTemplateName, UINT nStyle, UINT nID)
{
...
/////////////////////////////////////////////////////////////////////////////
BOOL CDlgHisto::Create(CWnd* pParentWnd, UINT nIDTemplate, UINT nStyle, UINT nID)
{
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CDlgHisto, CDialogBar)
...
void CDlgHisto::InitDlg()
{
	...
	m_gray.ShowWindow(SW_HIDE);

	m_ren=m_gen=m_ben=0;
	m_grayen=1;

	CButton* plog = (CButton*)GetDlgItem(IDC_LOG);
	if (plog) { plog->SetCheck(0); m_logen=0; }

	m_initok=true;
}

BOOL CDlgHisto::OnCommand(WPARAM wparam, LPARAM lparam) 
{
...
void CDlgHisto::OnPaint() 
{
	...
	CImageDoc* pDoc = (CImageDoc*) ((CMainFrame *)theApp.GetMainWnd())->GetActiveFrame()->GetActiveDocument();
