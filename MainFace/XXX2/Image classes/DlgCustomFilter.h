...
class CDlgCustomFilter : public CDialog
{
// Construction
public:
	CDlgCustomFilter(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlgCustomFilter)
	enum { IDD = IDD_DLG_Custom_Filter };
