...
CChart4Fila::CChart4Fila()
{
	m_bSelected = false;
}

bool CChart4Fila::DrawChartCurve(V_CHARTDATAD& vDataPntsD,GraphicsPath* grPathPtr, Graphics* grPtr, float dpiRatio)
{
...
bool CChart4Fila::ConvertChartData(V_CHARTDATAD& vDataPnts, V_CHARTDATAF& vDataPntsF, MatrixD* pMatrixD, double startX, double endX)
{
