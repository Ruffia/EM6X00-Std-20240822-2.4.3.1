...
bool CChart4HV::DrawChartCurve(V_CHARTDATAD& vDataPntsD,GraphicsPath* grPathPtr, Graphics* grPtr, float dpiRatio)
{
...
bool CChart4HV::ConvertChartData(V_CHARTDATAD& vDataPnts, V_CHARTDATAF& vDataPntsF, MatrixD* pMatrixD, double startX, double endX)
{
