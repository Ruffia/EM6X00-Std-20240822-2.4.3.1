...
void CDlgAutoTestLNS::EnableParams( int nIndex, BOOL bEnable )
{
	if( bEnable )
	{
		...
		case	0:
			// CondenserLens
			L1DACSB_Change( theApp.m_AT.nAutoTestLNS_OldPos[0] );
		...
		case	2:
			// ObjectiveLens
			L2SDACSB_Change( theApp.m_AT.nAutoTestLNS_OldPos[1] );
		...
		case	4:
			// BeemAlignmentX
			XalDACSB_Change( theApp.m_AT.nAutoTestLNS_OldPos[2] );
		...
		case	6:
			// BeemAlignmentY
			YalDACSB_Change( theApp.m_AT.nAutoTestLNS_OldPos[3] );
	...
	else
	{
		...
		str.Format( "%szAutoTestLNS-%s.txt", appfilepath, strTemp );
...
{
	// TODO: Add your control notification handler code here
	int nCheck = ((CButton*)(GetDlgItem(IDC_CHECK_AT_Cali_Start)))->GetCheck();
	if( nCheck )
	{
		int i;
		for( i=0; i<4; i++ )
		...
		theApp.m_AT.nAutoTestLNS_OldPos[0] = theApp.m_DL.diag[Diag_CL].nCurPos;
		theApp.m_AT.nAutoTestLNS_OldPos[1] = theApp.m_DL.diag[Diag_OL].nCurPos;
		theApp.m_AT.nAutoTestLNS_OldPos[2] = theApp.m_DL.diag[Diag_Align_X].nCurPos;
		theApp.m_AT.nAutoTestLNS_OldPos[3] = theApp.m_DL.diag[Diag_Align_Y].nCurPos;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CDlgAutoTestLNS::L1DACSB_Change( int nPos )
{
...
void CDlgAutoTestLNS::L2SDACSB_Change( int nPos )
{
	// This Sub uses global long DIOData (8 hex digits) as AccesIO USB write data
	int nValue;
	BYTE byteHi, byteLo;
...
void CDlgAutoTestLNS::XalDACSB_Change( int nPos )
{
	// This Sub uses global long DIOData (8 hex digits) as AccesIO USB write data
	int nValue;
	BYTE byteHi, byteLo;
...
void CDlgAutoTestLNS::YalDACSB_Change( int nPos )
{
	// This Sub uses global long DIOData (8 hex digits) as AccesIO USB write data
	int nValue;
	BYTE byteHi, byteLo;
